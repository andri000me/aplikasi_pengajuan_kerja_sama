        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Table Status Kerja Sama</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="<?= base_url();?>Dashboard/dashboard_admin">Dashboard</a>
                        </li>
                        <li class="breadcrumb-item active">Data Status Kerja Sama</li>
                    </ol>
                    <ol>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#tambah_data_status_kerja_sama">
                            Tambah Data Status Kerja Sama <i class="fas fa-plus"></i>
                        </button>
                    </ol>
                    <div class="card mb-4">
                  ...
                  $id = 0;
                  foreach($status_kerja_sama as $i)
                  :
                  $id++;
                  $id_status_kerja_sama = $i['id_status_kerja_sama'];
                  $status_kerja_sama = $i['status_kerja_sama'];
                 

              ?>
                                    <tr>
                                        <td><?= $id ?></td>
                                        <td><?= $status_kerja_sama ?></td>
                                        <td>
                                            <div class="table-resposive">
                                                <div class="table table-striped table-hover ">
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                        data-bs-target="#edit_data_status_kerja_sama<?= $id_status_kerja_sama ?>">
                                    ...
                                    <!-- Modal Edit Status Kerja Sama -->
                                    <div class="modal fade" id="edit_data_status_kerja_sama<?= $id_status_kerja_sama ?>"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?= base_url(); ?>status_kerja_sama/edit_data_admin"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                aria-describedby="status_kerja_sama"
                                                                name="status_kerja_sama"
                                                                value="<?= $status_kerja_sama ?>">
                                                        </div>
                        ...
                        <!-- Modal Tambah Status Kerja Sama -->
                        <div class="modal fade" id="tambah_data_status_kerja_sama" tabindex="-1"
